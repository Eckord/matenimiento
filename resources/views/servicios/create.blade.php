    ...
    <div class="row justify-content-center mt-0">
        <div>
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <center><h2><strong>Formulario Diagnóstico Inicial</strong></h2></center>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" action="{{route('servicios.store')}}">
                            {!! @csrf_field() !!}
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary float-right my-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            Agregar
                                        </button>
                                        <input class="form-control" type="text" name="cliente" id="cliente" list="clientes" placeholder="Ingresa cliente" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                        <input id="cliente_id" name="cliente_id" type="hidden">
                                        <datalist id="clientes">
                                        @foreach ($clientes as $cliente)
                                            <option value="{{$cliente->id.' - '.$cliente->nombre_cliente.' '.$cliente->apellido_paterno.' '.$cliente->apellido_materno}}">
                                        @endforeach
                                        </datalist>
                                        <input class="form-control" type="text" name="tipo" id="tipo" list="tipos" placeholder="Ingresa el tipo de dispositivo" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                        <input id="tipoDispositivo_id" name="tipoDispositivo_id" type="hidden">
                                        <datalist id="tipos">
                                        @foreach ($tipodispositivos as $tipodispositivo)
                                            <option value="{{$tipodispositivo->id.' - '.$tipodispositivo->tipo_dispositivo}}">
                                        @endforeach
                                        </datalist>
                                    </div>
                                        
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="numSerie" id="numSerie" placeholder="No. de serie" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                                        <input type="text" class="form-control" name="nombre_dispositivo" id="nombre_dispositivo" placeholder="Nombre" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                                        <input type="text" class="form-control" name="marca" id="marca" placeholder="Marca" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                                        <input type="text" class="form-control" name="modelo" id="modelo" placeholder="Modelo" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                                    </div>     
                                </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <hr>
                                    <textarea name="condiciones_fisicas" id="condiciones_fisicas" rows="5" cols="20" onkeyup="javascript:this.value=this.value.toUpperCase();">Condiciones físicas</textarea>
                                    <input type="text" class="form-control" name="sistema_operativo" id="sistema_operativo" placeholder="Sistema Operativo" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                                    <input type="text" class="form-control" name="contrasenia" id="contrasenia" placeholder="Contraseña de acceso al equipo"/> 
                                </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="form-group">
                                        <label >Listar el software instalado en el equipo de cómputo (separar por comas ',').</label>
                                        <div class="form-group" id="listaSoftware">
                                            <input type="text" class="form-control" name="nombre_software" id="nombre_software" placeholder="Nombre software" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <h3 class="fs-title">RESUMEN DE ORDEN</h3>
                                    <div class="form-group">
                                        <div class="container">
                                            <label>CLIENTE</label>  
                                            <input type="text" id="cliente2" disabled>
                                            <label>TIPO DE DISPOSITIVO</label>  
                                            <input type="text" id="tipo2" disabled>
                                            <div class="row">
                                                <div class="col">
                                                <label>DATOS DEL DISPOSITIVO</label>
                                                <input type="text" id="numSerie2" disabled/>
                                                <input type="text" id="nombre_dispositivo2" disabled/>
                                                <input type="text" id="marca2" disabled/>
                                                <input type="text" id="modelo2" disabled/> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="msform" method="POST" action="{{route('agregar')}}">
           
                <div class="modal-body">
                {!! @csrf_field() !!}
                    <input type="text" class="form-control" name="nombre_cliente" id="nombre_cliente" placeholder="Nombre cliente" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                    ...
                    <input type="tel" class="form-control" name="telefono_celular" id="telefono_celular" placeholder="(555)-555-5555" aria-describedby="helpCelular" />
                    <input type="email" class="form-control" name="correo_electronico" id="correo_electronico" placeholder="Correo electrónico" />
                </div>
