            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" action="{{route('mantenimiento.update',$servicio->id)}}">
                            @method('PUT')
                            {!! @csrf_field() !!}
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Anterior" />
                                <input type="submit" name="make_payment" class="next action-button" value="Terminar" />
                            </fieldset>                            
...
$(document).ready(function () {
    ...
    $("#actividad").keyup(function () {
        $("#estadoMantPrev").val(1);
    }); 
    $("#softwareActual").keyup(function () {
        $("#estadoMantCorrect").val(1);
    });                 
