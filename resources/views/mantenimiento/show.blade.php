            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        @if($mantenimiento->estado == 5)
                        <label style="color:red;">COSTO FINAL: ${{ $mantenimiento->costo_final }}</label>
                        @endif
                        @endforeach
                    </div>                                                          
                </div>
                ...
                @foreach($mantenimientos as $mantenimiento)
                <label><b><span style="@if($mantenimiento->estado == 5)background-color: #27E024; @else background-color: #FFFF00; @endif">DETALLADO MANTENIMIENTO:</span></b></label>
                <table>
                    <thead>
                        <tr role="row">
